...
void vulkan_renderpass_begin(
    ...
    pzero_memory(clear_values, sizeof(VkClearValue) * 2);
...
//   // Attachments not used in this subpass but need 
...
//   renderpass_info.attachmentCount = attachment_description_count;
//   renderpass_info.pAttachments = attachment_descriptions;
...
//   // Create renderpass and write it to our handle
//   VK_CHECK(vkCreateRenderPass(
//     context->device.logical_device,
//     &renderpass_info,
//     context->allocator,
...
//   VkClearValue clear_values[2]; // one for color and one for depth
//   pzero_memory(clear_values, sizeof(VkClearValue) * 2);
