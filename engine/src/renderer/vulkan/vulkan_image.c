...
void vulkan_image_create(
  ...
  i32 mem_type = context->find_memory_index(
    mem_requirements.memoryTypeBits,
    memory_flags
  );
  if (mem_type == -1) {
    P_ERROR("Required memory type not found. Image is not valid.");
  }
...
void vulkan_image_view_create(
  ...
  view_info.viewType = VK_IMAGE_VIEW_TYPE_2D; /// TODO: Make configurable
